...
{
    public static readonly string[] UePackageExtensions = ["uasset", "umap", "upk", "xxx", "udk", "u", "mbamap", "rbd", "aa3", "ut3", "mo"];
    ...
    [
        ...
        "bin", "ini", "uplugin", "upluginmanifest", "locres", "locmeta", "wem", "ewem", "bnk"
    ];

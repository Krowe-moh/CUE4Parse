...
{
    public static readonly string[] UePackageExtensions = ["uasset", "umap", "upk", "xxx", "XXX", "udk", "u", "mbamap", "sword", "rbd", "aa3", "ut3", "ut2", "utx", "unr", "umx", "uax", "usx", "ukx", "map", "lm", "s8m", "ccpk", "mo"];

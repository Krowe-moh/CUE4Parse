...
public class FPositionVertexBuffer
{
    ...
    public FPositionVertexBuffer(FArchive Ar)
    {
        ...
        if (Ar.Game is GAME_Valorant_PRE_11_2 or GAME_NeedForSpeedMobile || (Ar.Game is GAME_ArenaBreakoutInfinite && Stride == 8))
        {
            bool bUseFullPrecisionPositions = Ar.Game is GAME_ArenaBreakoutInfinite ? false : Ar.ReadBoolean();

...
public class CMaterialParams2
{
    ...
    public const string RegexDiffuse = ".*(?:Diff|_Tex|_?Albedo|_?Base_?Color).*|(?:_D|_DIF|_DM|_C|_CM|_DS)$";
    ...
    [
        [
            ...
            "Base Color [Standard]", "Base Color VT", "DS", "_DS", "PaintLines(R=TeamColored, A=LineAlpha)"
        ],

...
public class CMaterialParams2
{
    ...
    [
        [
            ...
            "BCM BaseColor|Metallic Map", "Color_Main", "Texture_BC", "DF", "DS", "_DS", "PaintLines(R=TeamColored, A=LineAlpha)", "D_diffuse_texture"
        ],
    ...
    [
        [
            ...
            "Normal - Texture", "Clothing Normal", "Normal [Standard]", "NCD_Mask", "Normal Map (Packed)", "N2R(M)","Normal Texture (N)", "N_NormalMap_texture"
        ],

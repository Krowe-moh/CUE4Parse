...
public class CMaterialParams2
{
    ...
    [
        [
            "Trunk_BaseColor", "ShadedDiffuse", "LitDiffuse", "Base Colour", "CLRM", "Diffuse_Map", "Base Color", "Base_Tex", "MobileBaseTexture", "BaseTex", "ColorTexture",
            ...
            "BCM BaseColor|Metallic Map", "Color_Main", "Texture_BC", "Virtual Texture Base Color", "DF", "DS", "_DS", "L01.BaseColor", "PaintLines(R=TeamColored, A=LineAlpha)", "D_diffuse_texture"
        ],
    ...
    [
        [
            "Trunk_Normal", "F2DetailNormal", "T_Normal", "normal", "normalmap", "NRRO", "Base Normal", "BaseNormalMap", "Normal Map",
            ...
            "Normal(HrNM)_Texture", "VT Normal", "L01.Normal.Metallic.Roughness", "N_NormalMap_texture"
        ],
    ...
    [
        [
            ...
            "MetallicRoughnessOcclusionSpecularTexture", "Virtual Texture ORM", "L01.Normal.Metallic.Roughness", "Spec"
        ],

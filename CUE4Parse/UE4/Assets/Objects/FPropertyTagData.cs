...
public class FPropertyTagData
{
    ...
    public static FPropertyTagData? GetArrayStructType(FAssetArchive Ar, string? name, int elementSize)
    {
        ...
        var map = new Dictionary<string, string[]>
        {
            ...
            ["EnumProperty"] = new[] { "Formats", "WheelsToChange", "LicenseWhitelist", "LicenseBlacklist", "SubTunePriority", "WeaponFiringMode", "TargetTypes" },
        ...
        {
            ["Vector"] = new[] { "FaceNormalDirections", "SourceOffsetDefaults", "ClothMeshNormalData", "PreCachedPhysScale", "EdgeDirections", "VertexData", "SpawnOffset", "PosKeys", "m_OpeningPosition", "m_ClosingPosition" },
            ["Quat"] = new[] { "RotKeys" },
            ["Rotator"] = new[] { "DecalRotation", "SpawnFacing" },
            ["Plane"] = new[] { "FacePlaneData", "PermutedVertexData" },
            ["LinearColor"] = new[] { "DefaultColorList", "ColorBlindColorList", "m_StateBGColors", "m_StateFontColors", "IconColor" },

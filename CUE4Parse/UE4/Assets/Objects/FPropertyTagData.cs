...
public class FPropertyTagData
{
    ...
    public static FPropertyTagData? GetArrayStructType(string? name, int elementSize)
    {
        ...
        return structType is not null ? new FPropertyTagData(structType, name) : new FPropertyTagData("StructProperty", name);
    }

...
public class FPropertyTagData
{
    ...
    public static FPropertyTagData? GetArrayStructType(FAssetArchive Ar, string? name, int elementSize)
    {
        ...
        {
            ["Vector"] = new[] { "ClothMeshPosData", "SampledHeight","ClothMeshNormalData", "FaceNormalDirections", "SourceOffsetDefaults", "ClothMeshNormalData", "PreCachedPhysScale", "EdgeDirections", "VertexData", "SpawnOffset", "PosKeys", "m_OpeningPosition", "m_ClosingPosition" },
            ["Quat"] = new[] { "RotKeys" },

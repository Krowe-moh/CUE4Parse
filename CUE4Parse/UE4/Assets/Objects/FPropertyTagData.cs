...
public class FPropertyTagData
{
    ...
    public static FPropertyTagData? GetArrayStructType(FAssetArchive Ar, string? name, int elementSize)
    {
      ...
      //      return new FPropertyTagData("FloatProperty", name);
        ...
        if (((gurt == "AnimNodeAimOffset" || gurt == "UTAnimNodeJumpLeanOffset") && name == "Profiles") || ((gurt == "TerrainLayerSetup" || gurt == "InterpTrackFloatMaterialParam" || gurt == "InterpTrackVectorMaterialParam") && name == "Materials") || (gurt == "InterpTrackSound" && name == "Sounds"))
        {
            return new FPropertyTagData("StructProperty");
        }
        if ((gurt == "UIImage" && name == "InactiveStates") || (gurt is "UIScene" && name == "Children") || (gurt == "LandscapeComponent" && name == "ShadowMaps") || (gurt == "ReachSpec" && name == "End"))
        {
        ...
        {
            ["Vector"] = new[] { "ClothMeshPosData", "SoftBodyTetraVertsUnscaled", "SampledHeight", "FaceNormalDirections", "SourceOffsetDefaults", "ClothMeshNormalData", "PreCachedPhysScale", "EdgeDirections", "VertexData", "SpawnOffset", "PosKeys", "m_OpeningPosition", "m_ClosingPosition" },
            ["Quat"] = new[] { "RotKeys" },
